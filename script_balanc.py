...
numero_novas_linhas = 50000

# Crie as novas linhas
novas_linhas = []
for _ in range(numero_novas_linhas):
    linha_existente = amostra.sample(n=1)  # Seleciona uma linha existente aleatoriamente
...
df_novo = amostra.append(novas_linhas, ignore_index=True)
